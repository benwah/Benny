...
fn main() {
    ...
    let mut online_network =
        NeuralNetwork::with_online_learning(&[2, 4, 1], 0.05, HebbianLearningMode::Classic);
    ...
    println!(
        "   Online Learning: {}",
        online_network.is_online_learning()
    );
    ...
    for i in 0..3 {
        ...
        println!(
            "  Pass {}: Weight unchanged: {:.6} → {:.6}, Output: {:.4}",
            i + 1,
            weight_before,
            weight_after,
            output[0]
    ...
    for i in 0..3 {
        ...
        println!(
            "  Pass {}: Weight adapted: {:.6} → {:.6} (Δ: {:+.6}), Output: {:.4}",
            i + 1,
            weight_before,
            weight_after,
            change,
